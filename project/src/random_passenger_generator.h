...
#ifndef _EXPORT_SCRATCH_RANDOM_PASSENGER_GENERATOR_H_
#define _EXPORT_SCRATCH_RANDOM_PASSENGER_GENERATOR_H_
...
#endif  // _EXPORT_SCRATCH_RANDOM_PASSENGER_GENERATOR_H_
