...
// // create about 7 * 20 * 16 = 2240 names out
// of 312 bytes of data (In my earlier
...
#include <string>
#include "src/passenger_factory.h"
#include "/export/scratch/passenger_factory.h"

/* 
 * if CONSPASS is defined, every passenger will have the 
 * same name and desination
...
// I am banking on multiplication to ensure a large number of names
// by using 7 prefixes and 20 stems, and 16 suffixes I should be able to
// create about 7 * 20 * 16 = 2240 names out of 312
// bytes of data (In my earlier
// example from the forum I used this code to generate male and female names,
// but here I combined them).
